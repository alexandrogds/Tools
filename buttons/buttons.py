...
def main():
    ...
    for lang in idiomas:
        ...
        translated_dir_name = translator.translate('buttons', src='auto', dest=lang).text
        ...
        input(f'1/{len(idiomas)}. Prosseguir = Enter.')
